...
public class ControladorTabla implements ActionListener{
	...
	public static void actualizarDatos(){
		...
		//Determinamos el n�mero de p�ginas completas que podemos crear
		int paginasTotales = (int) Math.ceil(personas.size() / NUMERO_REGISTROS); 
		if(paginaActual == paginasTotales + 2) paginaActual = 0;
		//Si no es exacto aqu� se guarda el numero de registro restante
		...
		for (int i = 0; i <  NUMERO_REGISTROS - 1; i++) {
			...
			// por la p�gina que se muestre y el n�mero de registros de esta
		...
		//Contador de p�ginas, dependiendo si hay una p�gina final incompleta
